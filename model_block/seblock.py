...
#
class SE_ASPP(nn.Module):  ##鍔犲叆閫氶亾娉ㄦ剰鍔涙満鍒?    def __init__(self, dim_in, dim_out, rate=1, bn_mom=0.1):
    ...
    def forward(self, x):
        ...
        seaspp1 = self.senet(feature_cat)  # 鍔犲叆閫氶亾娉ㄦ剰鍔涙満鍒?        # print('seaspp1:',seaspp1.shape)
